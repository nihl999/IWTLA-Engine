...
Camera::Camera() : Camera::Camera(glm::vec3(0)){};
Camera::Camera(glm::vec3 spawnPosition) : position(spawnPosition){};
void Camera::updateViewMatrix() {
  modelMatrix = glm::lookAt(position, position + forward, cameraUp);
...
glm::mat4 Camera::getViewMatrix() const { return finalViewMatrix; }
