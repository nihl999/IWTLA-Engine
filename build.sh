...
linkerFlags="-L../lib -lglfw3 -lglad -luser32 -lgdi32 -lopengl32 -limguiglgl -limgui -lflecs -lWs2_32 -lassimp -lz"

clang++ $cppFilenames $compilerFlags -o ../bin/$outName $includeFlags $linkerFlags